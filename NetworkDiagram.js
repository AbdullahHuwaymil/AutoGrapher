...
const NetworkDiagram = () => {
  ...
  const calculateMinimumFaultTolerance = async () => {
    try {
      const response2 = await fetch("/api/calculate-fault-tolerance", {
        method: "GET",
  ...
  function calculateAveragePathLength() {
    fetch("/api/calculate-average-path-length", {
      method: "GET",
    })
  ...
  function calculateMaxDiameter() {
    fetch("/api/calculate-diameter-path", {
      method: "GET",
    })
      .then((response) => response.json())
      .then((data) => {
  ...
  const calculateClustering = async () => {
    try {
      const response = await fetch("/api/detect-communities", {
        method: "GET",
        headers: { "Content-Type": "application/json" },
      });
  ...
  const findStronglyConnectedComponents = async () => {
    try {
      const response = await fetch("/api/find-strong-components", {
        method: "GET",
        headers: { "Content-Type": "application/json" },
      });
      const data = await response.json();
  ...
  const calculatePrimsMST = async () => {
    try {
      const response = await fetch("/api/calculate-mst-msa", {
        method: "GET",
        headers: { "Content-Type": "application/json" },
      });
      const data = await response.json();
  ...
  const CalculateRoutingTable = async (sourceNode) => {
    ...
    try {
      const response = await fetch(
        `/api/calculate-routing-table?source=${sourceNode}`,
        {
          method: "GET",
          headers: { "Content-Type": "application/json" },
        }
  ...
  const calculateDFSPath = async (sourceNode, targetNode) => {
    ...
    try {
      const response = await fetch("/api/calculate-dfs-path", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
  ...
  const calculateBFSPath = async (sourceNode, targetNode) => {
    ...
    try {
      const response = await fetch("/api/calculate-bfs-path", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
        body: JSON.stringify({ source: sourceNode, target: targetNode }),
      });
  ...
  const calculateDijkstraShortestPath = async (sourceId) => {
    ...
    try {
      const response = await fetch("/api/dijkstra-shortest-path", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
        body: JSON.stringify(requestBody),
      });
  ...
  const updateGraphTypeOnBackend = async (newGraphType) => {
    try {
      const response = await fetch("/api/update-graph-type", {
        method: "POST",
        headers: {
  ...
  const calculateAndDisplayFloydWarshall = async () => {
    try {
      const response = await fetch("/api/floyd-warshall", { method: "GET" });
      if (!response.ok) {
        throw new Error(`HTTP error! status: ${response.status}`);
      }
      const data = await response.json();
  ...
  async function fetchMaxEdgeWeight() {
    try {
      const response = await fetch("/api/get-max-edge-weight");
  ...
  const addToBackend = async (graphData) => {
    try {
      const response = await fetch("/api/add-graph", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
  ...
  const deleteLink = async () => {
    if (contextMenu.link) {
      try {
        const response = await fetch("/api/delete-edge", {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
          },
  ...
  const changeLinkWeight = async () => {
    if (contextMenu.link) {
      ...
      if (!isNaN(parsedWeight) && newWeight !== null) {
        ...
        try {
          const response = await fetch("/api/change-edge-weight", {
            method: "POST",
            headers: { "Content-Type": "application/json" },
            body: JSON.stringify({
              source: contextMenu.link.source,
  ...
  const calculateAdjacencyMatrix = async () => {
    try {
      const response = await fetch("/api/get-adjacency-matrix");
      if (!response.ok) {
        throw new Error(`HTTP error! status: ${response.status}`);
      }
      const data = await response.json();
  ...
  const handleChangeNodeId = async () => {
    if (contextMenu.node) {
      ...
      if (!isNaN(newNodeId) && !nodes.some((node) => node.id === newNodeId)) {
        try {
          const response = await fetch("/api/change-node-id", {
            method: "POST",
            headers: {
              "Content-Type": "application/json",
            },

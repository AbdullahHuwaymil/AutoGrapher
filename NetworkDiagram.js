...
const NetworkDiagram = () => {
  ...
  const calculateMinimumFaultTolerance = async () => {
    try {
      const response2 = await fetch("http://localhost:5000/calculate-fault-tolerance", {
        method: "GET",
  ...
  function calculateAveragePathLength() {
    fetch("http://localhost:5000/calculate-average-path-length", {
      method: "GET",
    })
  ...
  function calculateMaxDiameter() {
    fetch("http://localhost:5000/calculate-diameter-path", {
      method: "GET",
    })
      .then((response) => response.json())
      .then((data) => {
  ...
  const calculateClustering = async () => {
    try {
      const response = await fetch("http://localhost:5000/detect-communities", {
        method: "GET",
        headers: { "Content-Type": "application/json" },
      });
  ...
  const findStronglyConnectedComponents = async () => {
    try {
      const response = await fetch("http://localhost:5000/find-strong-components", {
        method: "GET",
        headers: { "Content-Type": "application/json" },
      });
      const data = await response.json();
  ...
  const calculatePrimsMST = async () => {
    try {
      const response = await fetch("http://localhost:5000/calculate-mst-msa", {
        method: "GET",
        headers: { "Content-Type": "application/json" },
      });
      const data = await response.json();
  ...
  const CalculateRoutingTable = async (sourceNode) => {
    ...
    try {
      const response = await fetch(
        `http://localhost:5000/calculate-routing-table?source=${sourceNode}`,
        {
          method: "GET",
          headers: { "Content-Type": "application/json" },
        }
  ...
  const calculateDFSPath = async (sourceNode, targetNode) => {
    ...
    try {
      const response = await fetch("http://localhost:5000/calculate-dfs-path", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
  ...
  const calculateBFSPath = async (sourceNode, targetNode) => {
    ...
    try {
      const response = await fetch("http://localhost:5000/calculate-bfs-path", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
        body: JSON.stringify({ source: sourceNode, target: targetNode }),
      });
  ...
  const calculateAndDisplayShortestPath = async (sourceId, targetId) => {
    ...
    try {
      const response = await fetch("http://localhost:5000/calculate-shortest-path", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
  ...
  const calculateDijkstraShortestPath = async (sourceId) => {
    ...
    try {
      const response = await fetch("http://localhost:5000/dijkstra-shortest-path", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
        body: JSON.stringify(requestBody),
      });
  ...
  const updateGraphTypeOnBackend = async (newGraphType) => {
    try {
      const response = await fetch("http://localhost:5000/update-graph-type", {
        method: "POST",
        headers: {
  ...
  const calculateAndDisplayFloydWarshall = async () => {
    try {
      const response = await fetch("http://localhost:5000/floyd-warshall", { method: "GET" });
      if (!response.ok) {
        throw new Error(`HTTP error! status: ${response.status}`);
      }
      const data = await response.json();
  ...
  const hanldeNodeDoubleClick = async () => {
    if (DoubleClikedNode1 !== null && DoubleClikedNode2 !== null) {
      ...
      if (!linkExists) {
        ...
        try {
          const response = await fetch("http://localhost:5000/add-edge", {
            method: "POST",
            headers: { "Content-Type": "application/json" },
            body: JSON.stringify({
  ...
  async function fetchMaxEdgeWeight() {
    try {
      const response = await fetch("http://localhost:5000/get-max-edge-weight");
  ...
  const ResetGraph = async (e, graphType) => {
    ...
    try {
      const response = await fetch("http://localhost:5000/reset-graph", {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
        },
  ...
  const handleAddNode = async () => {
    ...
    try {
      const response = await fetch("http://localhost:5000/add-node", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
  ...
  const deleteLink = async () => {
    if (contextMenu.link) {
      try {
        const response = await fetch("http://localhost:5000/delete-edge", {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
          },
  ...
  const changeLinkWeight = async () => {
    if (contextMenu.link) {
      ...
      if (!isNaN(parsedWeight) && newWeight !== null) {
        ...
        try {
          const response = await fetch("http://localhost:5000/change-edge-weight", {
            method: "POST",
            headers: { "Content-Type": "application/json" },
            body: JSON.stringify({
              source: contextMenu.link.source,
  ...
  const calculateAdjacencyMatrix = async () => {
    try {
      const response = await fetch("http://localhost:5000/get-adjacency-matrix");
      if (!response.ok) {
        throw new Error(`HTTP error! status: ${response.status}`);
      }
      const data = await response.json();
  ...
  const handleDeleteNode = async () => {
    if (contextMenu.node) {
      ...
      try {
        const response = await fetch("http://localhost:5000/delete-node", {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
          },
  ...
  const handleChangeNodeId = async () => {
    if (contextMenu.node) {
      ...
      if (!isNaN(newNodeId) && !nodes.some((node) => node.id === newNodeId)) {
        try {
          const response = await fetch("http://localhost:5000/change-node-id", {
            method: "POST",
            headers: {
              "Content-Type": "application/json",
            },
                      ...
                      >
                        ...
                        <button
                          ...
                          onClick={async (e) => {
                            ...
                            try {
                              const response = await fetch(
                                "http://localhost:5000/create_star_graph",
                                {
                                  method: "POST",
                                  headers: {
                                    "Content-Type": "application/json",
                      ...
                      >
                        ...
                        <button
                          ...
                          onClick={async (e) => {
                            ...
                            try {
                              const response = await fetch(
                                "http://localhost:5000/create_ring_graph",
                                {
                                  method: "POST",
                                  headers: {
                                    "Content-Type": "application/json",
                      ...
                      >
                        ...
                        <button
                          ...
                          onClick={async (e) => {
                            ...
                            try {
                              const response = await fetch(
                                "http://localhost:5000/create_bus_graph",
                                {
                                  method: "POST",
                                  headers: {
                                    "Content-Type": "application/json",
                        ...
                        <button
                          ...
                          onClick={async (e) => {
                            ...
                            try {
                              ...
                              const response = await fetch(
                                "http://localhost:5000/create_mesh_graph",
                                {
                                  method: "POST",
                                  headers: {
                                    "Content-Type": "application/json",
